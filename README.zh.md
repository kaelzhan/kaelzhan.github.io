...
* 如果你喜欢我的这个博客模板，请在`kaelzhan.github.io`这个repository点个赞——右上角**star**一下。
...
# SNS settings      
github_username: kaelzhan     # 你的github账号
weibo_username: kaelzhan      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/root/root.jpg     #你的大头贴，请使用绝对地址.
```
...
标题底图的选取完全是看个人的审美。每一篇文章可以有不同的底图，你想放什么就放什么，最后宽度要够，大小不要太大，否则加载慢啊。
